...
navbar = dbc.NavbarSimple(
    brand='CREDIT DEFAULT PREDICTOR',
    brand_href='/', 
    children=[
        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:odunkiruka@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/write2nk/Unit2-example'), 
